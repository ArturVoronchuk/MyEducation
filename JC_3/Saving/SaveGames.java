...
public class SaveGames {
    public static void saveGame(String path, GameProgress gameProgress) throws IOException {
        FileOutputStream outputStream1 = new FileOutputStream("D:/Games/savegames/save1.dat");
        FileOutputStream outputStream2 = new FileOutputStream("D:/Games/savegames/save2.dat");
        FileOutputStream outputStream3 = new FileOutputStream("D:/Games/savegames/save3.dat");
